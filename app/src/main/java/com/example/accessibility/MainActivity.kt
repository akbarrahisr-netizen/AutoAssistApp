...
class MainActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 1. ट्रेन नंबर का बॉक्स
        layout.addView(TextView(this).apply { text = "ट्रेन नंबर (जैसे 12487):"; setTextColor(Color.parseColor("#FF5722")) })
        val trainIn = EditText(this).apply { inputType = InputType.TYPE_CLASS_NUMBER; setText(prefs.getString("sel_train", "")) }
        layout.addView(trainIn)

        // 2. ऑटो रिफ्रेश टाइम का बॉक्स
        layout.addView(TextView(this).apply { text = "\nऑटो रिफ्रेश टाइम (HH:mm:ss):"; setTextColor(Color.RED) })
        val timeIn = EditText(this).apply { hint = "10:59:58"; setText(prefs.getString("t_time", "10:59:58")) }
        layout.addView(timeIn)

        // 3. क्लास चुनने का ऑप्शन
        layout.addView(TextView(this).apply { text = "\nक्लास चुनें (SL, 3A, 2A, 3E):"; setTextColor(Color.BLUE) })
        ...
        // 4. क्लिक स्पीड (Delay) का बॉक्स
        layout.addView(TextView(this).apply { text = "\nक्लिक के बीच की देरी (ms):" })
        ...
        for (i in 1..6) {
            ...
            val a = EditText(this).apply { hint = "उम्र"; layoutParams = LinearLayout.LayoutParams(0, -2, 1f); inputType = InputType.TYPE_CLASS_NUMBER; setText(prefs.getString("a$i", "")) }
        ...
        val saveBtn = Button(this).apply { text = "सब सेटिंग्स बॉक्स में सेव करें ✅" }
        saveBtn.setOnClickListener {
            val ed = prefs.edit()
            ed.putString("sel_train", trainIn.text.toString())
            ...
            ed.apply()
            Toast.makeText(this, "डाटा बॉक्स में सेव हो गया!", Toast.LENGTH_SHORT).show()
        }
